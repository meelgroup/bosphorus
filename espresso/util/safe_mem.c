 ...
 *
 *  The function pointer MMoutOfMemory2() contains a vector to handle a
...
void (*MMoutOfMemory2)() = MMout_of_memory;
...
#ifdef IBMPC
    if (size > 65000L) {
	if (MMoutOfMemory2 != (void (*)()) 0 ) (*MMoutOfMemory2)(size);
	return NIL(char);
    }
#endif
